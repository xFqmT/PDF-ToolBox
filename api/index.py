...
def compress_pdf():
    return "Compression feature temporarily disabled for deployment optimization", 501

@app.route('/pdf_to_word', methods=['POST'])
def pdf_to_word():
    return "PDF to Word feature temporarily disabled for deployment optimization", 501

@app.route('/pdf_to_images', methods=['POST'])
def pdf_to_images():
    return "PDF to Images feature temporarily disabled for deployment optimization", 501
